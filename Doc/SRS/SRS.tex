...
\begin{itemize}
    \item Tutorial videos and articles will be helpful in coming to understand both how JavaScript works, how React work, and how to improve the user interface
    \item Constant communication and pushing to the git repo will ensure that group members keep track of the progress of others, as well as the quality and styling of their code
\end{itemize}
...
\begin{itemize}
    ...
    \item Development approach will utilse CI/CD Pipeline
\end{itemize}
\subsubsection{Planning of the Development Phases}
% Abe can add the .PNG here

\subsection{Migration to the New Product}
\begin{itemize}
    \item Converting between Python and JavaScript typing, data structures, and syntax
...
\subsection{Costs}
So long as free online tutorials and resourses are used exclusively, the only costs will pertain to time devoted to developing the product, specifically in weekly meetings.

\subsection{User Documentation and Training}
Documentation of the different functions and files in the product will be provided seperately, detailing the purpose of the function, as well as how it operates, what variables it takes in, and what it outputs. 
...
\begin{itemize}
    \item 2-player mode
    \item Player customization of the game
\end{itemize}
