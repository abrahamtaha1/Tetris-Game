...
\sout{Game will display the "Play Again" button in the center of the window upon the current game ending.}
\textcolor{red}{Game shall display and End menu when the game has ended.}
...
\textcolor{red}{Score shall always be a positive whole number. Game block will only rotate by 90 degrees and block shall only move one grid box horizontally for each user input.}
...
\sout{Product should ensure that any device running a web browser should have capability to run the game.}
\textcolor{red}{Product shall be compatible with any PC running a Web Browser.}
